  ...
  return (
    <div>
      ...
      <div className='text-xl my-4'>
        <p className='text-gray-700 font-semibold dark:text-gray-200'>WHY <span className='text-gray-700 font-semibold dark:text-white'>CHOOSE US</span></p>
      </div>

      <div className='flex flex-col md:flex-row mb-20'>
        <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 cursor-pointer dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-primary dark:hover:text-white'>
          <b>EFFICIENCY:</b>
