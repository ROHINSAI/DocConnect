...
const Sidebar = () => {
  ...
  return (
    <div className='min-h-screen bg-white border-r dark:bg-gray-900 dark:border-gray-700 transition-colors'>
      {aToken && <ul className='text-[#515151] mt-5 dark:text-gray-300'>
      ...
      {dToken && <ul className='text-[#515151] mt-5'>
        ...
        <NavLink to={'/doctor-profile'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary dark:bg-gray-800' : 'hover:bg-gray-50 dark:hover:bg-gray-800'}`}>
          <img className='min-w-5' src={assets.people_icon} alt='' />
